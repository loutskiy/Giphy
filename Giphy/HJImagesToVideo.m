...
NSInteger const DefaultFrameRate                          = 24;
NSInteger const TransitionFrameCount                      = 24;
    ...
    while (1)
    {
		...
		if(writerInput.readyForMoreMediaData){
			...
			if (i >= [array count]) {
				...
				buffer = [HJImagesToVideo pixelBufferFromCGImage:[array[i] CGImage] size:CGSizeMake(1920, 1080)];
